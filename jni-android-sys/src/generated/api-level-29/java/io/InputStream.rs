...
__jni_bindgen! {
    ...
    public class InputStream ("java/io/InputStream") extends crate::java::lang::Object, implements crate::java::io::Closeable {

        /// [InputStream](https://developer.android.com/reference/java/io/InputStream.html#InputStream())
        pub fn new<'env>(__jni_env: &'env __jni_bindgen::Env) -> __jni_bindgen::std::result::Result<__jni_bindgen::Local<'env, crate::java::io::InputStream>, __jni_bindgen::Local<'env, crate::java::lang::Throwable>> {
