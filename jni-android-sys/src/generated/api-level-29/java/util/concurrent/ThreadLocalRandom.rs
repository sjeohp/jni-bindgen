...
__jni_bindgen! {
    ...
    public class ThreadLocalRandom ("java/util/concurrent/ThreadLocalRandom") extends crate::java::util::Random {
        ...
        // /// [ThreadLocalRandom](https://developer.android.com/reference/java/util/concurrent/ThreadLocalRandom.html#ThreadLocalRandom())
        // fn new<'env>(__jni_env: &'env __jni_bindgen::Env) -> __jni_bindgen::std::result::Result<__jni_bindgen::Local<'env, crate::java::util::concurrent::ThreadLocalRandom>, __jni_bindgen::Local<'env, crate::java::lang::Throwable>> {
        //     // class.path == "java/util/concurrent/ThreadLocalRandom", java.flags == (empty), .name == "<init>", .descriptor == "()V"
        //     unsafe {
        //         let __jni_args = [];
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/util/concurrent/ThreadLocalRandom\0", "<init>\0", "()V\0");
        ...
        // // Not emitting: Non-public method
        // /// [next](https://developer.android.com/reference/java/util/concurrent/ThreadLocalRandom.html#next(int))
        // fn next<'env>(&'env self, arg0: i32) -> __jni_bindgen::std::result::Result<i32, __jni_bindgen::Local<'env, crate::java::lang::Throwable>> {
        //     // class.path == "java/util/concurrent/ThreadLocalRandom", java.flags == PROTECTED, .name == "next", .descriptor == "(I)I"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0)];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/util/concurrent/ThreadLocalRandom\0", "next\0", "(I)I\0");
