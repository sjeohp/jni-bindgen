...
__jni_bindgen! {
    /// public interface [Set](https://developer.android.com/reference/java/util/Set.html)
    ///
    /// Required feature: java-util-Set
    public interface Set ("java/util/Set") extends crate::java::lang::Object, implements crate::java::util::Collection {
        ...
        /// [spliterator](https://developer.android.com/reference/java/util/Set.html#spliterator())
        ///
        ...
        pub fn spliterator<'env>(&'env self) -> __jni_bindgen::std::result::Result<__jni_bindgen::std::option::Option<__jni_bindgen::Local<'env, crate::java::util::Spliterator>>, __jni_bindgen::Local<'env, crate::java::lang::Throwable>> {
            // class.path == "java/util/Set", java.flags == PUBLIC, .name == "spliterator", .descriptor == "()Ljava/util/Spliterator;"
            unsafe {
                let __jni_args = [];
                let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
                let (__jni_class, __jni_method) = __jni_env.require_class_method("java/util/Set\0", "spliterator\0", "()Ljava/util/Spliterator;\0");
                __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
            }
        }
    }
