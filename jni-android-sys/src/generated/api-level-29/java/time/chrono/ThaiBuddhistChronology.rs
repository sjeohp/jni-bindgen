...
__jni_bindgen! {
    ...
    public final class ThaiBuddhistChronology ("java/time/chrono/ThaiBuddhistChronology") extends crate::java::time::chrono::AbstractChronology, implements crate::java::io::Serializable {
        ...
        // /// [ThaiBuddhistChronology](https://developer.android.com/reference/java/time/chrono/ThaiBuddhistChronology.html#ThaiBuddhistChronology())
        // fn new<'env>(__jni_env: &'env __jni_bindgen::Env) -> __jni_bindgen::std::result::Result<__jni_bindgen::Local<'env, crate::java::time::chrono::ThaiBuddhistChronology>, __jni_bindgen::Local<'env, crate::java::lang::Throwable>> {
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == (empty), .name == "<init>", .descriptor == "()V"
        //     unsafe {
        //         let __jni_args = [];
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "<init>\0", "()V\0");
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "resolveDate", .descriptor == "(Ljava/util/Map;Ljava/time/format/ResolverStyle;)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0.into()), __jni_bindgen::AsJValue::as_jvalue(&arg1.into())];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "resolveDate\0", "(Ljava/util/Map;Ljava/time/format/ResolverStyle;)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "eraOf", .descriptor == "(I)Ljava/time/chrono/Era;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0)];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "eraOf\0", "(I)Ljava/time/chrono/Era;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "date", .descriptor == "(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0.into())];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "date\0", "(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "dateNow", .descriptor == "(Ljava/time/Clock;)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0.into())];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "dateNow\0", "(Ljava/time/Clock;)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "dateNow", .descriptor == "(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0.into())];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "dateNow\0", "(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "dateNow", .descriptor == "()Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "dateNow\0", "()Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "dateEpochDay", .descriptor == "(J)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0)];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "dateEpochDay\0", "(J)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "dateYearDay", .descriptor == "(II)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0), __jni_bindgen::AsJValue::as_jvalue(&arg1)];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "dateYearDay\0", "(II)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "dateYearDay", .descriptor == "(Ljava/time/chrono/Era;II)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0.into()), __jni_bindgen::AsJValue::as_jvalue(&arg1), __jni_bindgen::AsJValue::as_jvalue(&arg2)];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "dateYearDay\0", "(Ljava/time/chrono/Era;II)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "date", .descriptor == "(III)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0), __jni_bindgen::AsJValue::as_jvalue(&arg1), __jni_bindgen::AsJValue::as_jvalue(&arg2)];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "date\0", "(III)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        //     // class.path == "java/time/chrono/ThaiBuddhistChronology", java.flags == PUBLIC | BRIDGE | SYNTHETIC, .name == "date", .descriptor == "(Ljava/time/chrono/Era;III)Ljava/time/chrono/ChronoLocalDate;"
        //     unsafe {
        //         let __jni_args = [__jni_bindgen::AsJValue::as_jvalue(&arg0.into()), __jni_bindgen::AsJValue::as_jvalue(&arg1), __jni_bindgen::AsJValue::as_jvalue(&arg2), __jni_bindgen::AsJValue::as_jvalue(&arg3)];
        //         let __jni_env = __jni_bindgen::Env::from_ptr(self.0.env);
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("java/time/chrono/ThaiBuddhistChronology\0", "date\0", "(Ljava/time/chrono/Era;III)Ljava/time/chrono/ChronoLocalDate;\0");
        //         __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
        //     }
        // }
        ...
        pub fn INSTANCE<'env>(env: &'env __jni_bindgen::Env) -> __jni_bindgen::std::option::Option<__jni_bindgen::Local<'env, crate::java::time::chrono::ThaiBuddhistChronology>> {
            unsafe {
                let (class, field) = env.require_class_static_field("java/time/chrono/ThaiBuddhistChronology\0", "INSTANCE\0", "Ljava/time/chrono/ThaiBuddhistChronology;\0");
