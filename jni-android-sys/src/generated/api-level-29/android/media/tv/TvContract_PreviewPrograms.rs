...
__jni_bindgen! {
    ...
    public final class TvContract_PreviewPrograms ("android/media/tv/TvContract$PreviewPrograms") extends crate::java::lang::Object, implements crate::android::media::tv::TvContract_BaseTvColumns {
        ...
        // /// [PreviewPrograms](https://developer.android.com/reference/android/media/tv/TvContract.PreviewPrograms.html#PreviewPrograms())
        // fn new<'env>(__jni_env: &'env __jni_bindgen::Env) -> __jni_bindgen::std::result::Result<__jni_bindgen::Local<'env, crate::android::media::tv::TvContract_PreviewPrograms>, __jni_bindgen::Local<'env, crate::java::lang::Throwable>> {
        //     // class.path == "android/media/tv/TvContract$PreviewPrograms", java.flags == (empty), .name == "<init>", .descriptor == "()V"
        //     unsafe {
        //         let __jni_args = [];
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("android/media/tv/TvContract$PreviewPrograms\0", "<init>\0", "()V\0");
        ...
        /// public static final [COLUMN_SERIES_ID](https://developer.android.com/reference/android/media/tv/TvContract.PreviewPrograms.html#COLUMN_SERIES_ID)
        ...
        pub fn CONTENT_URI<'env>(env: &'env __jni_bindgen::Env) -> __jni_bindgen::std::option::Option<__jni_bindgen::Local<'env, crate::android::net::Uri>> {
            unsafe {
                let (class, field) = env.require_class_static_field("android/media/tv/TvContract$PreviewPrograms\0", "CONTENT_URI\0", "Landroid/net/Uri;\0");
