...
__jni_bindgen! {
    ...
    public final class Telephony_Mms_Intents ("android/provider/Telephony$Mms$Intents") extends crate::java::lang::Object {
        ...
        // /// [Intents](https://developer.android.com/reference/android/provider/Telephony.Mms.Intents.html#Intents())
        // fn new<'env>(__jni_env: &'env __jni_bindgen::Env) -> __jni_bindgen::std::result::Result<__jni_bindgen::Local<'env, crate::android::provider::Telephony_Mms_Intents>, __jni_bindgen::Local<'env, crate::java::lang::Throwable>> {
        //     // class.path == "android/provider/Telephony$Mms$Intents", java.flags == (empty), .name == "<init>", .descriptor == "()V"
        //     unsafe {
        //         let __jni_args = [];
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("android/provider/Telephony$Mms$Intents\0", "<init>\0", "()V\0");
