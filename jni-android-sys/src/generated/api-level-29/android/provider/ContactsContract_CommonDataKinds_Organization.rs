...
__jni_bindgen! {
    ...
    public final class ContactsContract_CommonDataKinds_Organization ("android/provider/ContactsContract$CommonDataKinds$Organization") extends crate::java::lang::Object, implements crate::android::provider::ContactsContract_DataColumnsWithJoins, crate::android::provider::ContactsContract_CommonDataKinds_CommonColumns {
        ...
        // /// [Organization](https://developer.android.com/reference/android/provider/ContactsContract.CommonDataKinds.Organization.html#Organization())
        // fn new<'env>(__jni_env: &'env __jni_bindgen::Env) -> __jni_bindgen::std::result::Result<__jni_bindgen::Local<'env, crate::android::provider::ContactsContract_CommonDataKinds_Organization>, __jni_bindgen::Local<'env, crate::java::lang::Throwable>> {
        //     // class.path == "android/provider/ContactsContract$CommonDataKinds$Organization", java.flags == (empty), .name == "<init>", .descriptor == "()V"
        //     unsafe {
        //         let __jni_args = [];
        //         let (__jni_class, __jni_method) = __jni_env.require_class_method("android/provider/ContactsContract$CommonDataKinds$Organization\0", "<init>\0", "()V\0");
